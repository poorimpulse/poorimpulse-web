...
function ProcessRows(data, rows, key, usedColumns, filter) {
...
function createStream(sheet_id, key, usedColumns, filter) {
        ...
        sheet.useServiceAccountAuth(cred, function () {
            ...
            sheet.getInfo(function (err, info) {
                ...
                playerSheet.getRows(function (err, rows) {
                    ...
                    ProcessRows(data, rows, key, usedColumns, filter);
